...
const Menu = () => {
	...
	return (
		<>
		  <nav className={`flex items-end w-130.75 max-[1300px]:w-[435px] max-[1170px]:w-[360px] h-full max-[1100px]:absolute max-[1100px]:bg-light-blue max-[1100px]:top-[50px] max-[1100px]:left-0 max-[1100px]:w-screen max-[1100px]:h-[calc(100dvh-50px)] ${!isOpen && 'max-[1100px]:hidden'} z-20`}>
